...
struct Homepage: View {
    ...
    let coffeeShop : [CoffeeShopStruct] = [
        ...
        CoffeeShopStruct(name: "% Arabica",description: "lorem",distance: 134,steps: 412,calories: 531),
        CoffeeShopStruct(name: "36 Grams",description: "lorem",distance: 486,steps: 212,calories: 431),
        ...
        CoffeeShopStruct(name: "Dakoci",description: "lorem",distance: 256,steps: 102,calories: 45)
    ]
